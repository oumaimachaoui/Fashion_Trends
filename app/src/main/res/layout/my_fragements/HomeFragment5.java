...
public class HomeFragment5 extends Fragment {
   // String urladdress="http://192.168.56.1/AndroidProject/Selectaccess.php";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
     ...
     /*   Toast.makeText(context,"HOme fragement says::"+userid,
      ...
      /*  Toast.makeText(context,"HOme fragement says::"+userid+"hani"+iNO,
        ...
        new com.example.oumaima.my_fragements.HomeFragment5.Webservice().execute(urladdress);
            return rootView;
        }
...
//JSON
            ...
            context = getActivity();
            context = getContext();
            CustomListView CustomListView=new CustomListView((Activity) context,id,name,email,imagepath,color_product,rating_product,price_product,size_product, type_product);
            listView.setAdapter(CustomListView);
            pDialog.dismiss();
        }
    }
