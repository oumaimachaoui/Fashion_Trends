    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_no_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent accountsIntentdirect = new Intent(com.example.oumaima.my_fragements.Registeractibity.this,loginActivity.class);
                    ...
                    public void onClick(View v) {
                        ...
                        if (awesomeValidation.validate()){
                            ...
                            if(isInserted == true){
                                ...
                                Intent intentRegister = new Intent(com.example.oumaima.my_fragements.Registeractibity.this,loginActivity.class);
