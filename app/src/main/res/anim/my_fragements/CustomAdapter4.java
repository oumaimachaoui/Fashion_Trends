...
public class CustomAdapter4 extends BaseAdapter {
   ...
   // private ArrayList<String> size_product = new ArrayList<String>();
    ...
    public CustomAdapter4(Activity context, ArrayList<Integer> Id, ArrayList<String> Title, ArrayList<String> Description, ArrayList<String> Size_product
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       // final DatabaseHelper2 myDb = new DatabaseHelper2(context);
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.gritdlayout, null);
