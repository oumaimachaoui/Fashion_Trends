...
public class myService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Notification notification = new NotificationCompat.Builder(this, com.example.oumaima.my_fragements.App.CHANNEL_2_ID)
        ...
        Notification notification2 = new NotificationCompat.Builder(this, com.example.oumaima.my_fragements.App.CHANNEL_1_ID)
                .setSmallIcon(R.drawable.veryminilogo)
                .setContentTitle("Fashion Oumaima")
