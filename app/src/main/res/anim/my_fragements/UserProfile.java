    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.call:
                        Toast.makeText(com.example.oumaima.my_fragements.UserProfile.this, "call",Toast.LENGTH_SHORT).show();
                        Intent in = new Intent (Intent.ACTION_DIAL, Uri.parse( "tel:0677218995"));
                        startActivity(in);
                        return true;
                    case R.id.mycart:
                        Toast.makeText(com.example.oumaima.my_fragements.UserProfile.this, "mycart",Toast.LENGTH_SHORT).show();
                        Intent in2 = new Intent (com.example.oumaima.my_fragements.UserProfile.this, com.example.oumaima.my_fragements.ListChoices.class);
                        startActivity(in2);
                        return true;
                    case R.id.msg:
                        Toast.makeText(com.example.oumaima.my_fragements.UserProfile.this, "msg",Toast.LENGTH_SHORT).show();
                        Intent intent= new Intent( Intent.ACTION_SENDTO, Uri.parse("sms:0677218995"));
                        startActivity(intent);
                        intent.putExtra("sms", "ici un message ");
                        return true;
                    case R.id.settings:
                        Toast.makeText(com.example.oumaima.my_fragements.UserProfile.this, "aide",Toast.LENGTH_SHORT).show();
                        return true;
                    default:
                        return true;
                }
        ...
        *
        ...
        final com.example.oumaima.my_fragements.DatabaseHelper myDb = new com.example.oumaima.my_fragements.DatabaseHelper(this);
       ...
       // StringBuffer buffer = new StringBuffer();
        ...
        usersex=res.getString(5);
            Toast.makeText(com.example.oumaima.my_fragements.UserProfile.this,"Data Update"+userid,Toast.LENGTH_LONG).show();
    }
        ...
        button2.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder builder1 = new AlertDialog.Builder(com.example.oumaima.my_fragements.UserProfile.this);
                        LayoutInflater inflater = com.example.oumaima.my_fragements.UserProfile.this.getLayoutInflater();
                        ...
                        builder1.setPositiveButton("Update", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if(isUpdate == true)
                                    Toast.makeText(com.example.oumaima.my_fragements.UserProfile.this,"Data Update",Toast.LENGTH_LONG).show();
                                else
                                    Toast.makeText(com.example.oumaima.my_fragements.UserProfile.this,"Data not Updated",Toast.LENGTH_LONG).show();
                            }
        ...
        if(extras != null){
            ...
            btnviewuser.setOnClickListener(
                    new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Toast.makeText(com.example.oumaima.my_fragements.UserProfile.this,"FloatingActionButton"+userid,Toast.LENGTH_LONG).show();
                    }
                    });
        }
    }
