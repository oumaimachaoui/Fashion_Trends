...
public class Registeractibity extends AppCompatActivity {
    ...
    com.example.oumaima.my_fragements.DatabaseHelper myDb;
    ...
    String insertUrl = "http://192.168.56.1/AndroidProject/insertuser.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDb = new com.example.oumaima.my_fragements.DatabaseHelper(this);
        ...
        mDisplayDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        com.example.oumaima.my_fragements.Registeractibity.this,
        ...
        tv_no_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent accountsIntentdirect = new Intent(com.example.oumaima.my_fragements.Registeractibity.this, com.example.oumaima.my_fragements.loginActivity.class);
    ...
    public void AddData(){
        ...
        btnAddData.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(com.example.oumaima.my_fragements.Registeractibity.this, "Data Received Succesfully", Toast.LENGTH_SHORT).show();
                        ...
                        if (awesomeValidation.validate()){
                            ...
                            if(isInserted == true){
                                ...
                                Toast.makeText(com.example.oumaima.my_fragements.Registeractibity.this,"Data Inserted",Toast.LENGTH_LONG).show();
                                Intent intentRegister = new Intent(com.example.oumaima.my_fragements.Registeractibity.this, com.example.oumaima.my_fragements.loginActivity.class);
                               ...
                               startActivity(intentRegister);
                                ...
                                Toast.makeText(com.example.oumaima.my_fragements.Registeractibity.this,"Data not Inserted",Toast.LENGTH_LONG).show();
                        ...
                        {
                            Toast.makeText(com.example.oumaima.my_fragements.Registeractibity.this, "Error", Toast.LENGTH_SHORT).show();
                        }
                        }
                        else {
                            // Snack Bar to show success message that record is wrong
                            Toast.makeText(com.example.oumaima.my_fragements.Registeractibity.this, "Email early exist",Toast.LENGTH_LONG).show();
                        }
