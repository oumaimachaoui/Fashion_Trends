...
public class CustomAdapter extends BaseAdapter  {
    com.example.oumaima.my_fragements.DatabaseHelper3 myDb;
    ...
    public CustomAdapter(Context context, ArrayList<Integer> Id, ArrayList<String> nameproduct, ArrayList<Double> price_product, ArrayList<String> imagepath, ArrayList<String> color_product, ArrayList<String> size_product, ArrayList<Integer> qnt_product) {
        ...
        myDb = new com.example.oumaima.my_fragements.DatabaseHelper3(context);
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
     ...
     //   holder.r2=(ImageButton)rowView.findViewById(R.id.r2);
      ...
      //  holder.ivw.setImageResource(Integer.parseInt(imagepath.get(position)));
      //  holder.ivw.setImageResource(Integer.parseInt(imagepath.get(position)));
       ...
       // holder.tv_colorproduct.setText(color_product.get(position));
        holder.tv_colorproduct.setBackgroundColor(Color.parseColor(color_product.get(position)));
