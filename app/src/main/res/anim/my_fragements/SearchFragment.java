...
public class SearchFragment extends Fragment {
    String urladdress="http://192.168.48.2:80/AndroidProject/json2.php";
    String[] name;
    String[] email;
    String[] imagepath;
...
/*        Toast.makeText(context,"HOme fragement says::"+userid,
        ...
        new com.example.oumaima.my_fragements.SearchFragment.Webservice().execute(urladdress,iNO2);
...
//JSON
            ...
            Toast.makeText(context,"FROM WEBSERVICE CLASS::"+iNO2,
                    Toast.LENGTH_LONG).show();
            context = getContext();
            com.example.oumaima.my_fragements.CustomListView2 customListView=new com.example.oumaima.my_fragements.CustomListView2(context,name,email,imagepath,color_product,rating_product,price_product,size_product,iNO2);
            listView.setAdapter(customListView);
        }
    }
/*
