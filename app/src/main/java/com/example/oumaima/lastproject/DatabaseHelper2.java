...
public class DatabaseHelper2 extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME = "produitfav";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,title TEXT,description TEXT,image TEXT,color_product TEXT,size_product TEXT,Quantity INTEGER,type_product TEXT,price real,ratings INTEGER,user_id TEXT)");
    }
    ...
    public boolean updateCard(String qnt,String id ) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL_12,qnt);
