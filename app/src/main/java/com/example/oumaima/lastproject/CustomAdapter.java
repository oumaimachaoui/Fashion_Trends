...
public class CustomAdapter extends BaseAdapter  {
   ...
   // private String[] desc_product;
    ...
    String insertUrl = "http://192.168.48.2/AndroidProject/updateProduit3.php";
    String insertUrl2 = "http:/192.168.48.2/AndroidProject/updateProduit.php";
    private Context context;
    Bitmap bitmap;

    private static LayoutInflater inflater=null;

    public CustomAdapter(Context context, String[] nameproduct, double[] price_product, String[] imagepath, String[] color_product, String[] size_product, int[] qnt) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
       ...
       // holder.ivw.setImageResource(Integer.Int(imagepath[position]));
        holder.tv_colorproduct.setBackgroundColor(Color.parseColor(color_product[position]));
