...
public class HomeFragment extends Fragment {
    String urladdress="http://192.168.48.2/json.php";
    int[] id;
    String[] name;
    String[] email;
    String[] imagepath;
   ...
   String iNO=null;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(SessionManager.isLogged()) {
           ...
           // Toast.makeText(getActivity(), "Data Received UnSuccesfully"+pseudo+" "+id, Toast.LENGTH_SHORT).show();
        }
            context = getActivity();
            context = getContext();
       ...
       /* Toast.makeText(context,"HOme fragement says::"+userid+"hani"+iNO,
        ...
        new HomeFragment.Webservice().execute(urladdress);
            return rootView;
        }
...
//JSON
            ...
            try{
                ...
                for(int i=0;i<=ja.length();i++){
                    ...
                    type_product[i]=jo.getString("size_product");
                }
