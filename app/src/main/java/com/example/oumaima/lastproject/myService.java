...
public class myService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Toast.makeText(this, "StartCommand!"+message, Toast.LENGTH_SHORT).show();
       /**/  Notification notification = new NotificationCompat.Builder(this, com.example.oumaima.lastproject.App.CHANNEL_2_ID)
       ...
       Notification notification2 = new NotificationCompat.Builder(this, com.example.oumaima.lastproject.App.CHANNEL_1_ID)
                .setSmallIcon(R.drawable.veryminilogo)
                .setContentTitle("Fashion Oumaima")
