...
public class HomeFragment4 extends Fragment {
    String urladdress="http://192.168.48.2/AndroidProject/Selectpants.php";
    int[] id;
    String[] name;
    String[] email;
    String[] imagepath;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(SessionManager.isLogged()) {
           ...
           pseudoid= SessionManager.getId();
          //  Toast.makeText(getActivity(), "Data Received UnSuccesfully"+pseudo+" "+idpseudo, Toast.LENGTH_SHORT).show();
        }
        context = getActivity();
        context = getContext();
       ...
       /* Toast.makeText(context,"HOme fragement says::"+userid,
        ...
        new HomeFragment4.Webservice().execute(urladdress);
        return rootView;
    }
...
//JSON
            ...
            context = getActivity();
            context = getContext();
            Toast.makeText(getActivity(), "Data Received UnSuccesfully"+pseudo+" "+pseudoid, Toast.LENGTH_SHORT).show();

            com.example.oumaima.lastproject.CustomListView CustomListView=new com.example.oumaima.lastproject.CustomListView((Activity) context,id,name,email,imagepath,color_product,rating_product,price_product,size_product, type_product,pseudoid);
