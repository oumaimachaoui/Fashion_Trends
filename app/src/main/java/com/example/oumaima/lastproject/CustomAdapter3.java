...
public class CustomAdapter3 extends BaseAdapter {
   ...
   // private ArrayList<String> size_product = new ArrayList<String>();
    ...
    public CustomAdapter3(Activity context, ArrayList<Integer> Id, ArrayList<String> Title, ArrayList<String> Description, ArrayList<String> Size_product
       ...
       // final DatabaseHelper2 myDb = new DatabaseHelper2(context);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(finalConvertView1.getContext(), "You Clicked ", Toast.LENGTH_SHORT).show();
