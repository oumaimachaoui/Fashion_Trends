...
public class HomeFragment3 extends Fragment {
    ...
    String urladdress="http://192.168.48.2/AndroidProject/Selecttops.php";
    int[] id;
    String[] name;
    String[] type_product;
    String[] email;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        SessionManager =new SessionManager(getContext());
           if(SessionManager.isLogged()) {
               ...
               Toast.makeText(getActivity(), "Data Received Succesfully pseudo"+pseudo+"pseudoid "+pseudoid, Toast.LENGTH_SHORT).show();
           }
            // collectData();
            context = getActivity();
            context = getContext();
        ...
        new HomeFragment3.Webservice().execute(urladdress);
            return rootView;
        }
...
//JSON
            ...
            context = getActivity();
            context = getContext();
            Toast.makeText(getActivity(), "Data Received Succesfully"+pseudo+" "+pseudoid, Toast.LENGTH_SHORT).show();
            CustomListView CustomListView=new CustomListView((Activity) context,id,name,email,imagepath,color_product,rating_product,price_product,size_product, type_product,pseudoid);
